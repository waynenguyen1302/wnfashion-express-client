    ...
    <div className={`navbar ${ scrollDirection === "down" ? "hide" : "show"}`} >
      <div className="wrapper">
        <div className="left">
          ...
          <div className="item">
            <Link className ="link" to="/products/filter?category=women">Women</Link>
          </div>
          <div className="item">
            <Link className ="link" to="/products/filter?category=men">Men</Link>
          </div>
          <div className="item">
            <Link className ="link" to="/products/filter?category=children">Children</Link>
          </div>
        </div>
        <div className="center">
          <Link className ="link" to="/">Wayne'Store</Link>
        </div>
        <div className="right">
          <div className="item">
