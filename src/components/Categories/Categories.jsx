    ...
    <div className='categories'>
      <div className="col">
        <div className="row">
          ...
          <button>
            <Link className='link' to="/products/filter?category=clearance">Sale</Link>
          </button>
        </div>
        <div className="row">
          ...
          <button>
            <Link to="/products/filter?category=women" className="link">
              Women
            </Link>
          </button>
        </div>
      ...
      <div className="col col-l">
        <div className="row">
          <div className="col">
            <div className="row">
              ...
              <button>
                <Link to="/products/filter?category=men" className="link">
                  Men
                </Link>
              </button>
            </div>
          ...
          <div className="col">
            <div className="row">
              ...
              <button>
                <Link to="/products/filter?category=accesories" className="link">
                  Accessories
                </Link>
              </button>
            </div>
        ...
        <div className="row">
          <div className="row">
            ...
            <button>
              <Link to="/products/filter?category=children" className="link">
                Children
              </Link>
            </button>
          </div>
